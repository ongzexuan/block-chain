...
if (!process.env.dialogflow_token) {
    console.log('Error: Specify a Dialogflow dialogflow_token in environment.');
    usage_tip();
    process.exit(1);
}

if (!process.env.MONGODB_URI) {
    console.log('Error: Specify a MongoDB URI in environment.');
    usage_tip();
    process.exit(1);
}
*/
...
var controller = Botkit.facebookbot({
    ...
    stats_optout: true, //opt out of anonymous data collection by botkit
...
//                     controller.studio.run(bot, 'q_cryptocurrencies', message.user, message.channel, message);
//                 } else {
